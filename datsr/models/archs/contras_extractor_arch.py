...
class ContrasExtractorLayer(nn.Module):
    ...
    def __init__(self):
        ...
        conv3_1_idx = vgg16_layers.index('conv3_1')  # 在 RefSR 中，真正有用的是纹理和局部结构，而不是高层语义
    ...
    def forward(self, batch):
        batch = (batch - self.mean) / self.std # 归一化
...
class ContrasExtractorSep(nn.Module):
    ...
    def __init__(self):
        ...
        self.feature_extraction_image1 = ContrasExtractorLayer() # LR
        self.feature_extraction_image2 = ContrasExtractorLayer() # Ref  二者同构但不共享参数
    ...
    def forward(self, image1, image2):
        ...
        return {
            'dense_features1': dense_features1, # LR 的 VGG 特征
            'dense_features2': dense_features2  # Ref 的 VGG 特征
        }
